...
export default function Footer() {
  return (
    <footer className="border-t border-white/8 bg-[#203E5D] py-10 text-white">
      <div className="section-shell flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-5 max-w-md text-sm leading-7 text-white/45">
            Investing with leading global investors in differentiated opportunities across Israel&apos;s technology ecosystem.
          </p>
        </div>

        <div className="text-sm md:text-right">
          <p className="text-[10px] uppercase tracking-[0.28em] text-cyan-300">Contact</p>
      ...
      <div className="section-shell mt-9 flex flex-col gap-4 border-t border-white/8 pt-6 text-xs text-white/30 sm:flex-row sm:items-center sm:justify-between">
